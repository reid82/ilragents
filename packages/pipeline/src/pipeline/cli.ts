...
import { parseAndMergeSources, loadSources } from './parse-workbook';
import { calculateStatus, formatStatus, getFilteredSources, updateSourceStatus } from './status';
import { extractVimeoTranscript, saveTranscript } from './extractors/vimeo';
import { extractWebContent, saveWebContent } from './extractors/web-scraper';
import { extractPdfContent, savePdfContent } from './extractors/pdf';
import type { ContentSource, ContentType } from './types';
import { chat, startInteractiveChat } from './chat';
import {
  chunkAll,
  getChunkStats,
...
import { DATA_DIR, REPO_ROOT, PACKAGE_ROOT } from './config';

// Load environment variables from repo root and package root
