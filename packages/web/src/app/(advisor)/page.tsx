...
export default function AdvisorLandingPage() {
  ...
  async function startConversation(prompt: string) {
    ...
    try {
      ...
      const newId = await createConversation(token, title);
  ...
  return (
    <div className="flex-1 flex flex-col overflow-y-auto">
      <div className="flex-1 flex flex-col items-center justify-start px-4 py-10 sm:py-16 max-w-3xl mx-auto w-full">
        ...
        {/* Disclaimer */}
        <p className="text-xs text-zinc-600 text-center mb-8 max-w-md">
