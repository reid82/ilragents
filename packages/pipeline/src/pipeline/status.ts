...
import type { ContentSource, ContentType, SourcesData, StatusData } from './types';
import { STATUS_PATH, SOURCES_PATH } from './config';
...
export async function updateSourceStatus(
  ...
  await writeFile(SOURCES_PATH, JSON.stringify(sourcesData, null, 2));
}
